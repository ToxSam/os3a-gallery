...
const folderPageDescriptions: Record<string, string> = {
  '/resources/developers/database': 'Asset JSON structure and GitHub repository',
  '/resources/developers/website': 'Gallery website (os3a-gallery) GitHub repository',
  '/resources/about/glb': 'Learn about the GLB 3D format we use',
