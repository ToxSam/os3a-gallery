...
Open Source 3D Assets は、クリエイターによるキュレーションされたコレクションを掲載しています。主なソースは [open-source-3D-assets](https://github.com/ToxSam/open-source-3D-assets) リポジトリで、Polygonal Mind コレクションなどを含みます。
...
> **注：** コレクション一覧は [open-source-3D-assets](https://github.com/ToxSam/open-source-3D-assets) リポジトリの `data/projects.json` で管理されています。
