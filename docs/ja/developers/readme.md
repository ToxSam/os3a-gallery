...
[アセットデータベース](/ja/resources/developers/database) の構造と [open-source-3D-assets](https://github.com/ToxSam/open-source-3D-assets) リポジトリを確認してください。JSONデータを使って独自のブラウザやツールを構築できます。
